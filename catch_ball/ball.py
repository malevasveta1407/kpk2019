...
ball_available_colors = ['green', 'blue', 'red', 'yellow', '#FF00FF', '#AAAA00']
def click_ball(event):
    """Обработчик событий мышки для игрового холста
    :param event:событие с координатами клика
    По клику мышкой нкжно удалять тот объект, на который мышка указывает.
...
def init_ball_catch_game():
    """
    Создает необходимое для игры кольчество шариков, по которым нужно будет кликать
    """
